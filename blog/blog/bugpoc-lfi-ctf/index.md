...
- :smiling_imp: Steal /etc/passwd

- :skull: Bonus - Steal AWS Metadata and Source Code (at the end of this write-up) 
...
![Mock Builder](./img/bugpoc/first_try.png)
...
![BugPoC Redirect](./img/bugpoc/redirect.png)
